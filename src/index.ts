...
import { handlerCreateChirp, handlerDeleteChirp, handlerGetAllChirps, handlerGetChirpById } from "./api/chirps.js";
...
import { handlerUpgradeUser } from "./api/webhooks/polka.js";
